...
import {
  ...
  TimersE,
  YesNoE,
} from '../enum/ps-trunk-endpoints.enum';

export type PsTrunkEndpointsDocument = PsTrunkEndpoints & Document;

@Schema()
export class PsTrunkEndpoints {
  @Prop()
  type: string;
...
export const PsTrunkEndpointsSchema = SchemaFactory.createForClass(PsTrunkEndpoints);
